...
function Project() {
  return (
    <div className="bg-[#CBBDA3] w-full lg:h-[100vh] sm:h-[150vh] h-[200vh] ">
      <div className="flex flex-col justify-center items-center ">
        ...
        <div className="bg-[#E7DED5] w-full h-40 sm:order-3 order-4 flex flex-col flex flex-col justify-center items-center">
