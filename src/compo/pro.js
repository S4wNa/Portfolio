...
export const proj = [
  {
    ...
    text: " I made this app with Tauri ( Rust and React ), it create a ASCII path of any folder u drop on it, but when u try to download it it gives a warning since i didn't pay for the code sign",
    link: "https://ascii-tree-visualizer.netlify.app/",
  },
  {
    imgUrl: url2,

    text: " I made this Full Stack app with the Mern Stack, i still need to make few ajustment",
    link: "https://mycook.netlify.app/",
  },
  {
    imgUrl: url3,
